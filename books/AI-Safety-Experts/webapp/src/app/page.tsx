...
import { BookOpen, Shield, ArrowRight, Moon, Sun } from "lucide-react";
      ...
      <section className="hero-gradient text-white py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            ...
            className="animate-fade-in animate-delay-4 inline-flex items-center gap-2 bg-white text-emerald-700 font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all text-lg"
          >
            Start Reading
