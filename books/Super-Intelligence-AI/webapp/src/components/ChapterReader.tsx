...
import { CHAPTERS, getChaptersForBook, BOOK_INFO, type Chapter } from "@/lib/book-data";
...
export default function ChapterReader({ content, currentChapter }: ChapterReaderProps) {
  ...
  const bookChapters = getChaptersForBook(currentChapter.bookId);
  ...
  const nextChapter =
    currentIndex < bookChapters.length - 1 ? bookChapters[currentIndex + 1] : null;
      ...
      <nav className="fixed top-0 left-0 right-0 bg-[var(--surface)]/95 backdrop-blur-md border-b border-[var(--border-color)] z-40 no-print">
        <div className="flex items-center justify-between px-4 py-2 max-w-full">
          ...
          <div className="flex items-center gap-2 text-sm text-[var(--foreground)] opacity-60">
            <span className="hidden md:inline">Ch. {currentChapter.number}</span>
      ...
      <div className="flex pt-12 min-h-screen">
        ...
        >
          ...
          <div className="mb-10 pb-8 border-b-2 border-primary/20">
            <span className="inline-block px-3 py-1 text-sm font-medium rounded-full mb-3 bg-primary/10 text-primary">
              {currentChapter.part}
            </span>
            <h1 className="text-4xl md:text-5xl font-extrabold mb-2 text-primary">
            ...
            <div className="flex justify-between items-stretch gap-4">
              ...
              {nextChapter ? (
                ...
                <div className="flex-1 text-right p-4 rounded-xl border border-primary bg-primary/5">
                  <span className="text-sm text-primary font-bold">🎉 You finished this book!</span>
                  <Link
                    href="/"
