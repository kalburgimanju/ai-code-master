...
import { Play, Mail, Lock, Eye, EyeOff, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-dark-900 mt-6">Welcome back</h1>
          <p className="text-sm text-dark-500 mt-2">Log in to your account to continue</p>
        </div>

        {/* Form */}
        <form onSubmit={handleLogin} className="bg-white rounded-2xl shadow-sm border border-dark-100 p-8 space-y-5">
          {error && (
