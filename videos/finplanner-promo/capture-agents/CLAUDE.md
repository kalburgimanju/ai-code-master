...
Source: https://financialplanner-sand.vercel.app/agents
...
| `extracted/tokens.json` | Design tokens: 18 colors, 1 fonts, 12 headings, 3 CTAs |
...
- **Colors**: #0F172A (accent), #E2E8F0 (bg-light), #6366F1 (accent), #818CF8 (accent), #1E293B (accent), #FFFFFF (bg-light), #94A3B8 (neutral), #020617 (bg-dark), #4F46E5 (accent), #64748B (neutral)
