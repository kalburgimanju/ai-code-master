...
Source: https://financialplanner-sand.vercel.app/leads
...
| `extracted/tokens.json` | Design tokens: 16 colors, 1 fonts, 1 headings, 2 CTAs |
...
- **Colors**: #E2E8F0 (bg-light), #1E293B (accent), #0F172A (accent), #94A3B8 (neutral), #64748B (neutral), #020617 (bg-dark), #4F46E5 (accent), #FFFFFF (bg-light), #818CF8 (accent), #6366F1 (accent)
