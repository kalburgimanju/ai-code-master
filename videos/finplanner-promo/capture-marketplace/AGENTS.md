# FinPlanner — AI-Powered Financial & Real Estate Platform

Source: https://financialplanner-sand.vercel.app/marketplace
...
| `extracted/tokens.json` | Design tokens: 11 colors, 1 fonts, 2 headings, 2 CTAs |
...
- **Colors**: #E2E8F0 (bg-light), #1E293B (accent), #94A3B8 (neutral), #0F172A (accent), #020617 (bg-dark), #4F46E5 (accent), #FFFFFF (bg-light), #334155 (neutral), #CBD5E1 (surface-light), #818CF8 (accent)
