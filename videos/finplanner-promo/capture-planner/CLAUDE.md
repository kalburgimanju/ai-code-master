...
Source: https://financialplanner-sand.vercel.app/planner
...
| `extracted/tokens.json` | Design tokens: 9 colors, 1 fonts, 5 headings, 1 CTAs |
...
- **Colors**: #E2E8F0 (bg-light), #0F172A (accent), #1E293B (accent), #94A3B8 (neutral), #FFFFFF (bg-light), #020617 (bg-dark), #4F46E5 (accent), #818CF8 (accent), #6366F1 (accent)
