...
Source: https://financialplanner-sand.vercel.app/properties
...
| `extracted/tokens.json` | Design tokens: 16 colors, 1 fonts, 20 headings, 10 CTAs |
...
- **Colors**: #1E293B (accent), #E2E8F0 (bg-light), #0F172A (accent), #94A3B8 (neutral), #FFFFFF (bg-light), #334155 (neutral), #818CF8 (accent), #4F46E5 (accent), #6366F1 (accent), #020617 (bg-dark)
