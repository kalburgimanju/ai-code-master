...
Source: https://financialplanner-sand.vercel.app/properties/h1
...
| `extracted/tokens.json` | Design tokens: 14 colors, 1 fonts, 6 headings, 6 CTAs |
...
- **Colors**: #E2E8F0 (bg-light), #1E293B (accent), #0F172A (accent), #94A3B8 (neutral), #FFFFFF (bg-light), #6366F1 (accent), #818CF8 (accent), #020617 (bg-dark), #4F46E5 (accent), #334155 (neutral)
